 ...
 */
class PictureTypeFunctionalTest extends WebTestCase
{
  /**
   * @var null | Client
   */
  ...
  {
    $this->client->request('GET', '/update/trick/indy');
    static::assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
  }
  
  public function testPictureType()
  {
    $crawler = $this->client->request('GET', '/tricks/indy');
