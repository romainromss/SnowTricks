 ...
 */
final class Version20181115075927 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id UUID NOT NULL, username VARCHAR(10) NOT NULL, name VARCHAR(10) NOT NULL, lastname VARCHAR(20) NOT NULL, password VARCHAR(65) NOT NULL, email VARCHAR(50) NOT NULL, role VARCHAR(255) NOT NULL, createdAt INT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_pictures DROP CONSTRAINT FK_6FF1CBC0A76ED395');
        ...
        $this->addSql('ALTER TABLE user_pictures DROP CONSTRAINT FK_6FF1CBC0EE45BDBF');
